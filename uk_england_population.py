...
def pick_name(ethnicity: str, gender: str, born=None) -> str:
    e = ethnicity or ""
    g = _g(gender)
    tier = _tier(born)
...
def build_england_prompt(skeleton: dict, tier: str) -> str:
    ...
    return (
        ...
        "4. Occupation must match the SOC major group AND economic activity, and "
        "its seniority must fit the person's age: no 20-somethings as CEOs, "
        "directors, partners or 'Head of' / 'Senior' roles — those imply age 35+. "
        "If retired or inactive, describe the most recent or typical occupation.\n"

...
def _apply_socioeconomic_correlations(s: dict) -> dict:
    ...
    if not employed:
        ...
        # grants), except retirees with high grade who may hold wealth income.
        if ea == "Full-time student":
            _nudge_income_ceiling(s, _INCOME_INDEX["£25,000 – £34,999"], 0.7)
                    ...
                    "Economically inactive - other",
                    "Economically inactive - home or family"):
            _nudge_income_ceiling(s, _INCOME_INDEX["£35,000 – £49,999"], 0.5)
    else:
        ...
        # seniority and earnings both take time.
        if age is not None and age < 22:
            _nudge_income_ceiling(s, _INCOME_INDEX["£35,000 – £49,999"], 0.8)
